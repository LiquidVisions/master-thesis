...
\usepackage[style=authoryear-comp,maxbibnames=9,maxcitenames=2,uniquelist=false,backend=biber]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\include{Chapters/TheoreticalBackgroud/TheoreticalBackground.tex}
\include{Chapters/Requirements/Requirements.tex}
\include{Chapters/Artifacts/Artifacts.tex}
\include{Chapters/Evaluation/Evaluation.tex}
\include{Chapters/Discussion/Discussion.tex}
\include{Chapters/Conclusion/Conclusions.tex}
\include{Chapters/Reflection/Reflections.tex}
...
\include{Appendices/ERD.tex}
\include{Appendices/InstallationInstructions.tex}
\include{Appendices/Architectures.tex}
