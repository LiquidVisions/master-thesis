...
\ref{sec_research_questions}, we need to know what violations in the context of \gls{ns}
...
effects. However, as described in section \ref{sec_artifact_requirements}, the artifacts
