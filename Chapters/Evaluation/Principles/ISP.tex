...
\evaluatePrincipleTable{\gls{isp}}{tab_convergence_isp}{
    \addEvalRow{ \gls{soc} & \conv & The \gls{isp} converges with the \gls{soc} theorem, as
    ...
    \addEvalRow{\gls{dvt} & \partconv & The \gls{isp} has an indirect relationship with the
    ...
    \addEvalRow{\gls{avt} & \partconv & The \gls{isp} supports the \gls{avt} theorem. Both
    ...
    \addEvalRow{\gls{sos} & \noconv &  There is no alignment between \gls{isp} and \gls{sos}.
