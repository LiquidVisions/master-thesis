...
\begin{table}[H]
    \begin{tabular}{ l | c | p{0.79\linewidth}}
        \toprule
        \acrshort*{soc} & \conv & This principle converges with the \gls{soc} theorem.
        ...
        \gls{soc}.\\
        \midrule
        \acrshort*{dvt} & \partconv &  Adhering to the \gls{dip} can indirectly support the
        ...
        \midrule
        \acrshort*{avt} & \partconv & The \gls{dip} can support the \gls{avt} theorem. Both
