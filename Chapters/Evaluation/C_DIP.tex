...
\begin{table}[H]
    \begin{tabular}{ l | c | p{0.78\linewidth}}
        ...
        effectively manage complexity. Dependency Injection is a useful (but not the only
        or mandatory) aspect of \gls{dip}. We have observed that the claim that the
        ...
        alignment between \gls{dip} and \gls{avt} is not as strong as with \gls{soc}, and
        adhering to \gls{dip} alone will not guarantee a system that fully complies to
        \gls{avt}. \\ 
        \midrule
