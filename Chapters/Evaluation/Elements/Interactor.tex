...
\evaluateElementTable{Interactor}{tab_convergence_interactor}{
    ...
    \addEvalRow{Task & \conv &  The Task element in \gls{ns} is very closely related to
        the Interactor element of \gls{ca}, as both encapsulate the execution of business
        logic.}

    \addEvalRow{Flow & \partconv & The Interactor and Flow elements are partly convergent, as the
