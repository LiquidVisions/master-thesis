...
\evaluatePrincipleTable{\gls{ocp}}{tab_convergence_ocp}{
    \addEvalRow{\acrshort*{soc} & \conv & The \gls{ocp} converges with the \gls{soc} theorem.
    ...
    \addEvalRow{ \acrshort*{dvt} & \partconv & The \gls{ocp} supports the \gls{dvt} theorem. While
    ...
    \addEvalRow{\acrshort*{avt} & \conv & The \gls{ocp} converges with the \gls{avt} theorem. Both
