...
\begin{table}[H]
    \begin{tabular}{ l | c | p{0.79\linewidth}}
        \toprule
        \gls{soc} & \conv & This principle converges with the \gls{soc} theorem.
        ...
        \gls{soc}.\\
        \midrule
        \gls{dvt} & \partconv &  Adhering to the \gls{dip} can indirectly support the
        ...
        \midrule
        \gls{avt} & \partconv & The \gls{dip} can support the \gls{avt} theorem. Both
