...
\begin{table}[H]
    \begin{tabular}{ l | c | p{0.80\linewidth}}
        \toprule
        \gls{soc} & \conv & The \gls{isp} converges with the \gls{soc} theorem, as
        ...
        \midrule
        \gls{dvt} & \partconv & The \gls{isp} has an indirect relationship with the
        ...
        \midrule
        \gls{avt} & \partconv & The \gls{isp} supports the \gls{avt} theorem. Both
