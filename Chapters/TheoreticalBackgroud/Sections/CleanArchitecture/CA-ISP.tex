...
the example of the \citecode{koks_appseederinteractor_2023} (see \ref{SipISPExample}) only
...
approach would lead to dependencies to all CRUD operations in the \code{koks_appseederinteractor_2023}.
