...
\evaluateElementTable{Presenter}{tab_convergence_presenter}{
    \addEvalRow{Data & \noAlignment &  The Presenter and Data element are not convergent. However, Data
        elements might be transformed into a suitable format for the user inter interface
        by \gls{ca}'s Presenter element.}

    \addEvalRow{Task & \noAlignment &  The Presenter and Task elements are not convergent. The
    ...
    \addEvalRow{Flow & \noAlignment & The Presenter and Flow element are not convergent. The Flow
    ...
    \addEvalRow{Connector & \noAlignment & The Presenter and Connector elements are not convergent.
    ...
    \addEvalRow{Trigger & \noAlignment & The Presenter and Trigger elements are not convergent, as the
