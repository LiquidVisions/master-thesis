...
\usepackage[style=authoryear-icomp,maxbibnames=9,maxcitenames=2,uniquelist=false,backend=biber]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
...
\subject{A Design Science approach of modulairity,\\ stability and evolvability of a C\#
...
\include{Chapters/ArtifactOne/ArtifactOne.tex}
\include{Chapters/ArtifactTwo/ArtifactTwo.tex}
\include{Chapters/Evaluation/EvaluationResults.tex}
