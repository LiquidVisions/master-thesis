...
\evaluatePrincipleTable{\gls{dip}}{tab_convergence_dip}{
    \addEvalRow{\acrshort*{soc} & \conv & This principle converges with the \gls{soc} theorem.
    ...
    \addEvalRow{\acrshort*{dvt} & \partconv &  Adhering to the \gls{dip} can indirectly support the
    ...
    \addEvalRow{\acrshort*{avt} & \partconv & The \gls{dip} can support the \gls{avt} theorem. Both
    ...
    \addEvalRow{\acrshort*{sos} & \noconv & There is a very weak alignment between \gls{dip} and
