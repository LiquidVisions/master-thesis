...
\evaluateElementTable{Controller}{tab_convergence_controller}{ \addEvalRow{Data &
    \noAlignment & There is no alignment between the Controller element of \gls{ca} and
    the Data element of \gls{ns} and no manifestations are found in the Artifact.}

    \addEvalRow{Task & \noAlignment &  There is no alignment between the Controller
    ...
    \addEvalRow{Connector & \partialAlignment & Although the Controller of \gls{ca}
    ...
    \addEvalRow{Trigger & \partialAlignment & Although the Controller of \gls{ca} supports
