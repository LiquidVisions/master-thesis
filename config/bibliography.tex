...
\newglossaryentry{Combinatorial Effects}
{
    name=Combinatorial Effects,
    description={Instabilities, the accumilation of required changes on new versions of the system.}
}
