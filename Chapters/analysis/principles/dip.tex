...
\gls{dip} states that high-level modules should not depend on low-level modules. By
adhering to \gls{dip} correctly, the architecture promotes modular architectures and
component layers, as described in 2.3.4 The Dependency rule \parencite{koks_layers_2023}.
Managing dependencies inherently promotes \gls{soc}. Therefore \gls{dip} converges with
\gls{soc} to some extent. However, adhering to \gls{dip} does not guarantee \gls{soc}.
