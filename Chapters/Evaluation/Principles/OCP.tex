...
\begin{table}[H]
    \begin{tabular}{ l | c | p{0.80\linewidth}}
        \toprule
        \acrshort*{soc} & \conv & The \gls{ocp} converges with the \gls{soc} theorem.
        ...
        \acrshort*{dvt} & \partconv & The \gls{ocp} supports the \gls{dvt} theorem. While
        ...
        \acrshort*{avt} & \conv & The \gls{ocp} converges with the \gls{avt} theorem. Both
